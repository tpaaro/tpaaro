	...
	if (oigsus){
		...
		t2ring = TextIO.getlnInt();
			...
			if (suva == t2ring) {
				...
				System.out
						.println("Ehh... kahjuks õnn seekord ei naeratanud. " + suva + " oli 6nnelik arv silmi.");
				krediit -= panus;
				System.out.println("Krediidi j22k: " + krediit);
}
			if (krediit == 0){
				System.out.println("Game Over, madafaka! Better luck next time");
				break;}
				else  {	System.out.println("Kas soovid mangu jatkata? Jah(0) Ei (1)");
