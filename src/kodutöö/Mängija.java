...
public class Mängija {
	 ...
	 * 
	 * @param	 kaart	kaart, mis lisatakse
	...
	public int käeSumma() {
		...
		// kui  meil ässad ja summa on > 21, muudame mõne/kõigi ässa(de) väärtused: Äss = 1
	 ...
	 * 
	 * @param näita1stKaarti otsustada, kas esimene kaart jätta peidetuks või mitte
	 */
